...
# 日志
LOG_URL = FileUtil.generate_logfile_url("logs/poc.log")
logger = LogUtil.Logger(LOG_URL)
# 常量
URLS_FILE = 'urls.txt'
BASE_URL = 'https://oceancolor.gsfc.nasa.gov/showimages/MODISA/IMAGES/POC/L3'
SAVE_DIR = 'F:\Ocean\MODIS_AQUA_POC'

...
class DataLoaderH(object):
    ...
    def getdataloader(self):
        ...
        train_loader = DataLoader(dataset=train_dataset, batch_size=self.batchSize, num_workers=0, pin_memory=False,
                                  shuffle=True)
        test_dataset = Dataset(test_set, test_set_y)
        test_loader = DataLoader(dataset=test_dataset, batch_size=test_set_y.shape[0], num_workers=0, pin_memory=False,
                                 shuffle=False)
